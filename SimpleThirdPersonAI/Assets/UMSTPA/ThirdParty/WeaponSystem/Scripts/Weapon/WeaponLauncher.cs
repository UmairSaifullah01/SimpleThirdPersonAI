...
public class WeaponLauncher : WeaponBase
{
	...
	[HideInInspector]
	public bool Reloading, outOfBullet;
	[HideInInspector]
	public float ReloadingProcess;
	public int maxBullet, bulletCount;
                ...
                for (int i = 0; i < NumBullet; i++) {
					if (Missile) {
						...
						if (RigidbodyProjectile) {
                            ...
                            Quaternion q = Quaternion.AngleAxis (curveAmount * factor, rigidbody.velocity);
                            bullet.GetComponent<Rigidbody> ().MoveRotation (q);
                        }
